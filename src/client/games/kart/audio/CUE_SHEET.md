...
| Turbo | Phone + host | Host confirms a boost activation. | High priority one-shot with a 140 ms attack and 320 ms release so the nitro roar blends into the engine. Phone gain 0.46; host gain 0.27. Maximum two overlapping voices. Briefly ducks music on host. |
